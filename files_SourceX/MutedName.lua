local function DaddyMuslim_SrcX(msg)
...
database:sadd(bot_id.."SourceX:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."SourceX:blocname"..msg.chat_id_)
...
function DaddyMuslim_name(t1,t2)
if t2.id_ then 
name_SrcX = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_SrcX then 
names_SrcX = database:smembers(bot_id.."SourceX:blocname"..msg.chat_id_) or ""
if names_SrcX and names_SrcX[1] then 
for i=1,#names_SrcX do 
if name_SrcX:match("(.*)("..names_SrcX[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, DaddyMuslim_name)
end
end
return {
SourceX = DaddyMuslim_SrcX,
}
